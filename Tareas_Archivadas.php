<?php //continue.php
    ...
    if (isset($_SESSION['nombre']))
    {
        ...
        echo "<a href=mostrar.php>Todas las Tareas</a></h4>  " ;
               ...
               $query = "SELECT * FROM tarea where estado = 'archivado' and username = '$username' 
               ...
               if($filas==0){
                   die(" <FONT SIZE=6 COLOR='red'>NO TIENE TAREAS ARCHIVADAS </FONT><br><br>
                   <a href='ingresar_tareas.php'>Agregar Tareas</a> <br><br>
                   <a href=cerrar.php>Cerrar sesion</a>");
               }
           
               echo "<table BORDER=3 CELLPADDING=10 CELLSPACING=10> <tr> <th colspan=8><h1><FONT COLOR='green'>TAREAS ARCHIVADAS</FONT></h1></th> 
